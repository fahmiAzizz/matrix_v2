...
router.patch('/userEmployee/:id', authMiddleware_1.verifyToken, userEmployee_1.updateUserAndEmployee);
router.delete('/userEmployee/:id', authMiddleware_1.verifyToken, userEmployee_1.deleteUserAndEmployee);
